...
This is the foundation — tracking all income and expenses accurately.
...
Manages spending limits and provides real-time feedback.
...
This module helps users *see patterns* instead of guessing.

**Responsibilities**

* Time-series charts
* Trend comparison (month vs month, daily vs daily)
